<template>
  ...
  <section class="wire page-main-surface relative overflow-hidden pt-[160px] pb-[100px] px-5 md:pb-[200px] snap-page">
    <div class="mx-auto max-w-[1280px]">
      ...
      <p
        class="mx-auto mt-4 max-w-[640px] text-center text-sm md:text-lg"
          ...
          <div class="wire__keyboard-mini">
            ...
            >
              <span
                ...
                :key="k"
                class="wire__key"
                :class="{ 'wire__key--acti': actiSet.has(k) }"
              >{{ k }}</span>
            </div>
          </div>
        </div>
    ...
    <div class="mt-20 md:mt-28">
      ...
      <MarqueeScroll :duration="60">
        <div
          ...
          class="wire__creator"
        >
          <div class="wire__creator-avatar">
            {{ c.name.slice(0, 2) }}
          </div>
          <div class="wire__creator-name">
            {{ c.name }}
          </div>
          <div class="wire__creator-stats">
            {{ c.skills }} Skills · {{ c.downloads }} Downloads
          </div>
        </div>
      </MarqueeScroll>
    </div>
